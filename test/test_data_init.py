...
valid_file_test_cases = (
    ...
    [
        ("Happy non-required", {'name': 'test', 'extention': 'json', 'path': 'data/test.json'}, True),
        ("No path", {'name': 'test', 'extention': 'json', 'path': ''}, False),
        ("No name", {'name': '', 'extention': 'json', 'path': 'data/.json'}, False),
        ("No extention", {'name': 'test', 'extention': '', 'path': 'data/test.json'}, False),
        ("Wrong extention", {'name': 'test', 'extention': 'py', 'path': 'data/test.py'}, False),
    ]
)
...
def test_valid_file_required_list_emptied():
    ...
    input = {'name': 'someString', 'extention': 'json', 'path': 'data/someString.json'}
    assert data.valid_file(input, required=required)
